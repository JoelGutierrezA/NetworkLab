...
import { JwtPayload, RowDataPacket, hasMessage } from '../types';
...
export class AuthController {
    ...
    static async register(req: Request, res: Response) {
        try {
            ...
            const errorMessage = hasMessage(error) ? error.message : 'Error en el servidor';
    ...
    static async refreshToken(req: Request, res: Response) {
        ...
        try {
            ...
            // 2) Decodificar token
            const decoded: JwtPayload | null = AuthUtils.decodeToken(oldToken);
    ...
    static async verifyToken(req: Request, res: Response) {
        try {
            ...
            const decoded: JwtPayload | null = AuthUtils.decodeToken(token);
