...
export class ServicesApiService {
  // Using backend equipment routes (CRUD) as the services source.
  // Default to localhost backend. If you need to change it, update this value
  // or configure a runtime global in your build pipeline.
